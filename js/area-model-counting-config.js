 ...
 * please modify area-model-counting/package.json to control dependencies.
 *
 * RequireJS configuration file for the area-model-counting sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'area-model-counting-main' ],
