 ...
 * please modify area-model-introduction/package.json to control dependencies.
 *
 * RequireJS configuration file for the area-model-introduction sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'area-model-introduction-main' ],
