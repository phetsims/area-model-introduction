...
=============
"Area Model Introduction" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/area-model-introduction/latest/area-model-introduction_en.html" target="_blank">Click here to
run "Area Model Introduction".</a>
...
(5) Open in the browser: `http://localhost/area-model-introduction/area-model-introduction_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/area-model-introduction/build/adapted-from-phet/area-model-introduction_en_adapted-from-phet.html` (You will
