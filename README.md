...
(3) Open `http://localhost/area-model-introduction/area-model-introduction_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
